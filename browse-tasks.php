...
<div class="card mt-2 mb-2">
        ...
        <div class="row d-flex pt-3 pb-2" style="align-content:center;"> 
          ...
          <div class="col-12"><p style="font-size:17px"><span class="text-primary"><?php if($value['status'] =='runing'){ echo "<span style='color:green;font-size:14px'>Open</span>"; }else{ echo "Close"; }?></span> 
           ...
           <div class="col-4 text-center"> <h4><?php echo ucwords($value['task_currency']).ucwords($value['task_budget']);?></h4>
             ...
             <img class="pt-3" src="img/<?php  echo $img; ?>" width="60">
             </a>
           </div>
          </div>
