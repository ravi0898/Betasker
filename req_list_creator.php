...
<div class="title pt-1 pl-2">
    <span class="subtitle"><h6>Payment Request</h6></span>
    <span><a href="pay.php" class="text-white">Add Balance</a></span>
...
<h4 class="pt-0" style="color:#05a0c7">Project Budget</h4>
<h1 class="pt-2"><i class=""></i><?php echo $task_currency; ?><?php echo $remaining_budget; ?>.00</h1>
</div>
...
<div class="pt-1">
<h5 class="pl-1"> <i class="fa fa-check-circle"></i> <?php echo $data['title'];?></h5>
<p><i class="fa fa-calendar"></i> <?php echo $data['date'];?></p>
<?php if($data['status']=='0'){ ?>
<p class="float-right"><a href="controller/api/req_updchat.php?id=<?php echo $data['id'];?>&chat=<?php echo $_GET['chat']?>">Approve</a></p>
<p class="float-right"><a href="controller/api/req_decline.php?id=<?php echo $data['id'];?>&chat=<?php echo $_GET['chat']?>">Decline</a></p>
<?php } ?>
