...
$update  = mysqli_query($con,"UPDATE task_apply SET status='1' WHERE account_id='$task_receiver'");
$update2 = mysqli_query($con,"UPDATE task_create SET task_status='0',task_budget='$task_budget' WHERE task_id='$task_id'");
...
<p style='font-size: 14px; line-height: 160%;'><span style='font-size: 18px; line-height: 28.8px;'>  Your  proposal request is approved. <br> </span></p>
