...
// set product property values
    ...
    // }
       ...
       $response = array(
        ...
        $sql = mysqli_query($con,"INSERT INTO `account`(`date`,`time`,`account_id`,`fullname`,`email_address`,`password`,`role`,`mobile_no`,`reg_otp_email`) VALUES('" . $date . "','" . $time . "','" . $account_id . "','".$fullname."','".$email_address."','".$password."','".$role."','".$mobile_no."','".$mail_otp."')");
