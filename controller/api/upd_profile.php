...
if(isset($_POST['submit'])){
    ...
    $update = mysqli_query($con,"UPDATE `profile` SET fname='$fname',lname='$lname',suburb='$suburb',tagline='$tagline',about='$about',dob='$dob',abn='$abn',transportation='$transportation',language='$language',education='$education',work='$work',specialities='$specialities' WHERE account_id='$uid'");
    
    }else{
    
     $insert = mysqli_query($con,"INSERT INTO `profile` (`account_id`, `fname`, `lname`, `suburb`, `tagline`, `about`, `dob`, `abn`, `transportation`, `language`, `education`, `work`, `specialities`) VALUES ('$uid', '$fname', '$lname', '$suburb', '$tagline', '$about', '$dob', '$abn', '$transportation', '$language', '$education', '$work','$specialities')");
    }   
