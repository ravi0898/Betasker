...
<div class="media">
<img class="img-fluid w-15 circle" src="img/<?php echo $datas['img'];?>" class="mr-3" alt="...">
<div class="media-body">
<h5 class="mt-1 pt-2 text-dark pl-2"><?php echo ucwords($str[0]);?> - <?php echo ucwords(substr($data['task_title'],0,30)."...");?><?php if($get_rom_id == $room_id){ echo "(".$get_count_msg.")"; }?></h5>
<!--<p>Will you do the same for. </p>-->
</div>
</div>
</div>
