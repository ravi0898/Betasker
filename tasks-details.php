...
<div class="card card-outline px-2">

<div class="card-content card-content-padding pb-3">

<a href="profile.php?id=<?php  echo $response_data->account_id; ?>">

<img class="img-fluid w-15 float-left circle" src="img/<?php  echo $response_data->img; ?>" alt="" style="margin-right: 10px;">
</a>

 <h3 class="pt-2 pl-2" style="font-size:17px;color:#05a0c7;max-width: 270px;"><?php  echo ucwords($response_data->task_title); ?></h3>
...
<?php } ?>
<p class="float-right"><a href="adbudget.php?task_id=<?php echo $_GET['task_id'];?>" class="badge badge-success" style="font-size:15px;color:#fff!important;">Increase Budget</a></p>
...
?>
<!------->
<div class="card card-outline px-2 py-3">
<div class="card-content card-content-padding">

<div class="item-inner">
  <div class="col-80">
<div class="media mb-2">
<a href="profile.php?id=<?php  echo $records->account_id; ?>"><img class="img-fluid w-15" src="img/<?php echo $records->img;?>" alt="..."></a>
