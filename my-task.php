...
<div class="" style="margin-top:7px"></div>
    ...
    <li class="nav-item col-6">
      <a class="nav-link <?php if($_GET['tab'] =='tasks'){ echo "active"; }else if($_GET['tab'] =='booking'){ echo ""; }else { echo "active"; }?>" data-toggle="tab" href="#home">Tasks</a>
    </li>
    <li class="nav-item col-6">
      <a class="nav-link <?php if($_GET['tab'] =='booking'){ echo "active"; }else if($_GET['tab'] =='tasks'){ echo ""; }else { echo ""; }?>" data-toggle="tab" href="#menu1">Bookings</a>
    </li>
    ...
    <div id="home" class="tab-pane <?php if($_GET['tab'] =='tasks'){ echo "show active"; }else if($_GET['tab'] =='booking'){ echo "";}else{ echo "show active";}?>"><br>
      ...
      <div class="form-group">
         <select class="form-control" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
          ...
          <option value="my-task.php?val=runing&tab=tasks">Open</option>
          <option value="my-task.php?val=close&tab=tasks">Close</option>
          <option value="my-task.php?tab=tasks">All</option>
         </select>
      </div>  
     </div>
 <?php
...
?>
     ...
     <div class="card">
        ...
        <div class="row d-flex" style="align-content:center;" style="margin-right:0px!important;margin-left:0px!important;"> 
          ...
          <div class="col-12">
          <p style="font-size:17px"><span class="text-primary"><?php if(($val2->status) =='runing'){ echo "<span style='color:green;font-size:14px'><span class='badge badge-success'>Open</span></span>"; }else if(($val2->status) =='close'){ echo "<span class='badge badge-danger'>Close</span>"; }else{ echo "<span class='badge badge-danger'>Archive</span>"; }?></span> 
           ...
           <div class="col-4 text-center"> <h4><?php echo $val2->task_currency.$val2->task_budget;?></h4>
             <a href="profile.php?id=<?php  echo $val2->account_id; ?>"><img class="pt-3" src="img/<?php echo $val2->img;?>" width="60"></a> 
           </div>
          </div>
     ...
     <div class="card">
        ...
        <div class="row d-flex" style="align-content:center;" style="margin-right:0px!important;margin-left:0px!important;"> 
          ...
          <p style="font-size:17px">
            <span class="text-primary"><?php if(($val->status) =='runing'){ echo "<span style='color:green;font-size:14px'><a href='controller/api/archive.php?task_id=$task_ids&status=archive'><span class='badge badge-danger'>Archive</span></a></span>"; }else if(($val->status) =='close'){ echo "<span class='badge badge-danger'>Close</span>"; }else{ echo "<span style='color:green;font-size:14px'><a href='controller/api/archive.php?task_id=$task_ids&status=runing'><span class='badge badge-success'>Unarchive</span>"; }?></span> 
           ...
           <div class="col-4 text-center"> <h4><?php echo $val->task_currency.$val->task_budget;?></h4>
             <a href="profile.php?id=<?php  echo $val->account_id; ?>"><img class="pt-3" src="img/<?php echo $val->img;?>" width="60"></a>
           </div>
          </div>
